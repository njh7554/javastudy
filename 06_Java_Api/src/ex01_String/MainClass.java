...
public class MainClass {
   ...
   str2 | 0x456 |
	...
	public static void lastIndexOf() {
		...
		int idx2 = slogan.lastIndexOf("남진혁");
	...
	public static void startsWith() {
		...
		// startsWith
		// 문자열이 지정된 정규식 패턴으로(Regular Expression)으로 시작하면 true 반환
		
		// endsWith
		// 문자열이 지정된 정규식 패턴으로(Regular Expression)으로 끝나면 true 반환
		...
		if(name.startsWith("남")) {
			System.out.println("남씨다.");
		} else {
			System.out.println("남씨가 아니다.");
		}
	...
	public static void contains() {
		...
		String email = "njh7554@naver.com";
	...
	public static void replace() {
		...
		String replacedIp = ip.replace(".", "_"); // (replaceAll)61_78_121_242을 기대하지만 다른 정답이 나옴(정규식에서 마침표는 모든 문자를 의미함)
			System.out.println(replacedIp);
	}
	
	public static void isEmpty() { //*********수업에서 자주 사용*********** 
