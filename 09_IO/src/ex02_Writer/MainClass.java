...
public class MainClass {
	...
	public static void ex01() {
		...
		try {
			// 출력 스트림 생성
			fw = new FileWriter(file);  // 반드시 예외 처리가 필요한 코드(try catch)
		...
		// 출력 스트림으로 문자 보내기
				...
				char[] cbuf = {' ', 'a', 'm'};
				String str = " a boy.";
				fw.write(c);				 	// 반드시 예외 처리가 필요한 코드(try catch)
				fw.write(cbuf);				 	
				fw.write(str);			
	...
	public static void ex04() {
		...
		try(BufferedWriter bw = new BufferedWriter(new FileWriter(file))) { // ********************************최종버전(암기)*****************************
