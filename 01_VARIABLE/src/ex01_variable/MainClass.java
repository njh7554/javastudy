...
public class MainClass {
	...
	/* 
	  multiple comment - 여러 줄의 주석
	 */
	
	/*
	  키워드 이름 규칙
	  1. 프로젝트 : 마음대로
	  2. 패키지 : 소문자로 작성. 실무에서는 회사 도메인과 앱 이름으로 작성(com.samsung.galaxy) 
	  3. 클래스 : 첫 글자만 대문자로 작성하고 나머지는 소문자. Upper Camel Case 방식. (HelloWorld)
	  4. 매소드 : 첫 글자만 대문자로 작성하고 나머지는 소문자. Lower Camel Case 방식. (helloWorld)
	...
	String name = "남진혁"; //java에서 기본 타입과 같은 사용법을 제공
